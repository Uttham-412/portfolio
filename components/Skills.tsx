...
export default function Skills() {
  ...
  useEffect(() => {
    ...
    const blobs = container.querySelectorAll<HTMLElement>("div");
  ...
  return (
    <section id="skills" className="relative pt-32 pb-section-gap">
      <div
        ref={blobContainerRef}
        className="fixed inset-0 pointer-events-none overflow-hidden z-0"
      >
        <div className="absolute -top-[10%] -left-[10%] w-[40%] h-[40%] rounded-full bg-white/[0.02] blur-[120px]" />
        <div className="absolute top-[40%] -right-[10%] w-[30%] h-[30%] rounded-full bg-white/[0.01] blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {skillCategories.map((category) => (
            <div
              key={category.title}
              className={`glass-card-skills p-10 rounded-xl flex flex-col justify-between min-h-[260px] ${
          ...
          <div className="glass-card-skills p-1 rounded-xl md:col-span-2 overflow-hidden relative group cursor-pointer h-[260px]">
